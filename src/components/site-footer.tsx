...
export function SiteFooter() {
  return (
    <footer className="page-shell pb-10 pt-4 md:pb-12 md:pt-6">
      <div className="soft-panel flex flex-col gap-5 rounded-[2rem] px-5 py-5 md:gap-5 md:px-7 md:py-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <a
            ...
            className="focus-ring inline-flex w-fit items-center gap-2.5 rounded-full border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-2.5 text-sm text-[color:var(--foreground)] shadow-[0_10px_22px_rgba(75,63,110,0.05)] transition hover:-translate-y-0.5 hover:border-[color:var(--border-strong)] hover:text-[color:var(--accent-strong)]"
          >
            ...
            <div className="flex flex-wrap items-center gap-2.5 md:justify-end">
              {footerSocialLinks.map(({ href, label, icon: Icon }) => (
                <a
                  ...
                  aria-label={label}
                  title={label}
                  className="focus-ring inline-flex h-10 w-10 items-center justify-center rounded-[0.95rem] border border-[color:var(--border)] bg-[color:var(--surface)] text-[color:var(--muted)] shadow-[0_8px_18px_rgba(75,63,110,0.04)] transition hover:-translate-y-0.5 hover:border-[color:var(--border-strong)] hover:text-[color:var(--accent-strong)]"
                >
